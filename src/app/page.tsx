      ...
      <div className={"w-full h-fit bg-secondary-100 flex flex-col"}>
        ...
        <div className="w-full flex">
          <div className={"mt-[208px] ml-[100px] w-1/2"}>
            <h1 className={"text-primary-500 text-5xl mb-5 font-serif"}>
              Banner Title
            </h1>
            <p className={"text-primary-400 mb-10 font-sans"}>
        ...
        <div className={"mt-[120px] w-full text-center h-screen"}>
          <h2 className={"text-primary-500 text-[40px] mb-[30px]"}>
            Our Meal Types
          </h2>
          <h3 className={"text-primary-400 text-[16px] font-sans mb-[41px]"}>
            Text for our meal types
          </h3>
